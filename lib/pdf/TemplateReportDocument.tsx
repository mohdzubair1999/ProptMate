        ...
        {data.sections.map((section) => (
          <View key={section.id} style={styles.section} wrap>
            ...
            {section.fields.map((field) => {
              ...
              // Individual photos and inventory items are their own atomic elements — they
              // won't split mid-image or mid-item regardless of whether the outer field
              // container is allowed to wrap. Preventing the container from wrapping doesn't
              // protect anything; it just risks pushing the whole field to the next page
              // when it doesn't fully fit, leaving a visible gap behind.
