  ...
  return (
    <main>
      ...
      <div className="mt-8 grid sm:grid-cols-2 gap-4">
        ...
        <Link href="/dashboard/settings/integrations" className="bg-white border border-line rounded-xl p-6 hover:border-ink transition-colors">
          <h2 className="font-display font-600 text-lg text-ink">Integrations</h2>
          <p className="text-sm text-slate mt-1">Connect a CRM so a new tenancy automatically schedules its check-in.</p>
        </Link>

        <Link href="/dashboard/settings/security" className="bg-white border border-line rounded-xl p-6 hover:border-ink transition-colors">
          <h2 className="font-display font-600 text-lg text-ink">Security</h2>
          <p className="text-sm text-slate mt-1">Review suspicious activity on public forms and the integrations webhook, and block an IP if needed.</p>
        </Link>
        ...
        <Link href="/dashboard/settings/recently-deleted" className="bg-white border border-line rounded-xl p-6 hover:border-ink transition-colors">
          <h2 className="font-display font-600 text-lg text-ink">Recently deleted</h2>
          <p className="text-sm text-slate mt-1">Restore an inspection or report deleted by accident.</p>
        </Link>
