...
import DisputeRiskBadge from "./dispute-risk-badge";
...
type Item = {
  ...
  disputeRiskClassification: string | null;
  disputeRiskReasoning: string | null;
  disputeRiskConfidence: string | null;
  disputeRiskEvidenceNote: string | null;
  disputeRiskAssessedAt: Date | null;
};
        ...
        <div className="flex-1">
          ...
          {inspectionType === "check-out" && (
            <DisputeRiskBadge
              itemId={item.id}
              initial={{
                classification: item.disputeRiskClassification,
                reasoning: item.disputeRiskReasoning,
                confidence: item.disputeRiskConfidence,
                evidenceNote: item.disputeRiskEvidenceNote,
                assessedAt: item.disputeRiskAssessedAt ? item.disputeRiskAssessedAt.toISOString() : null,
              }}
            />
          )}
