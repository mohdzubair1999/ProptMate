    ...
    <main className="max-w-lg">
      ...
      <form action={updateProperty} className="mt-8 space-y-4">
        ...
        <div>
          ...
          <input name="landlordName" defaultValue={property.landlordName || ""} className="mt-1 w-full border border-line rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-signal" />
        </div>
